vame_slot_nms_get__ <- function() {
  ...
  c("var_set_meta_get", "var_set_meta_set", "var_set_meta_get_all",
  "var_set_var_nm_set_get_all", "var_set_var_nm_set_get", "var_set_var_nm_set_set",
  "var_set_rename", "var_set_remove", "var_set_value_space_get",
